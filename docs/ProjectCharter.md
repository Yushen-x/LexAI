...
| --- | --- | --- | --- |
| Project Title | LexAI: Intelligent Legal Assistance System | Project ID | LEXAI-2026-SPRING |
| Project Type | Course Project Prototype | Charter Date | March 25, 2026 |
| Project Start Date | March 9, 2026 | Projected Finish Date | June 15, 2026 |
| Project Manager | Xiao Xiangyu | Faculty Advisor | Du Bowen |

## 2. Project Stakeholders

### 2.1 Names, Titles or Roles, Phone Numbers, and E-mail Addresses

| Name | Title or Role | Phone Number | E-mail Address | Participation Focus |
| --- | --- | --- | --- | --- |
| Xiao Xiangyu | Team Leader / Project Manager / Security and Compliance Reviewer | 19107898485 | 2351110@tongji.edu.cn | Participates across architecture design, AI capability integration, frontend and backend development, system integration, testing, and final delivery, while also taking on milestone control and cross-module coordination |
| Hu Baoyi | Team Member | 18702192128 | 2353409@tongji.edu.cn | Participates across platform construction, with stronger focus on model-service refinement, output-logic tuning, and feature-quality improvement |
| Da Sirui | Team Member | 18190637896 | 2352288@tongji.edu.cn | Participates across platform construction, with stronger focus on workflow organization, interaction polishing, and presentation-layer consistency |
| Lin Qi | Team Member | 13560269169 | 2352609@tongji.edu.cn | Participates across platform construction, with stronger focus on interface integration, testing follow-up, deployment preparation, and document consolidation |
| Du Bowen | Faculty Advisor / Course Supervisor | N/A | N/A | Provides academic guidance, milestone review, and course-level feedback |
...
| Objective | Metric | Baseline (Q1 2026) | Target (By June 2026) |
| --- | --- | --- | --- |
...
### 5.1 What Will Be Included in the Scope of This Project
...
### 5.2 What Will Be Considered Outside the Scope of This Project
...
### 6.3 Project Reviews and Review Dates
...
### 7.1 Total Project Budget

| Budget Item | Amount | Notes |
| --- | ---: | --- |
| Total Direct Budget | 3,500 CNY | Modest direct costs only; student labor is not included |

### 7.2 Budget Broken Down by Phase
...
### 8.1 Specific Quality Requirements
...
| --- | --- | --- |
| Xiao Xiangyu | Full project participation | Contributes to architecture design, AI capability integration, frontend and backend development, system integration, and overall project coordination |
| Hu Baoyi | Full project participation | Stronger focus on model-service refinement, logic tuning, and platform capability polishing |
| Da Sirui | Full project participation | Stronger focus on workflow organization, interaction presentation, and platform-use coherence |
| Lin Qi | Full project participation | Stronger focus on interface integration, testing follow-up, deployment preparation, and delivery materials |
| Du Bowen | Review as needed | Faculty guidance and milestone feedback |
...
| RAG and knowledge-base tooling | Retrieval support for selected legal scenarios |
...
### 10.1 Assumptions Used to Develop Estimates
...
### 10.2 Key Risks, Probability of Occurrence, and Impact

| Risk | Probability | Impact | Mitigation Plan | Owner |
| --- | --- | --- | --- | --- |
| Limited manpower and overlapping coursework | High | High | Lock MVP scope, prioritize critical features, and review workload weekly | Xiao Xiangyu |
| AI hallucination in legal answers | Medium | High | Use retrieval grounding, prompt constraints, disclaimer design, and manual benchmark review | Hu Baoyi |
| Data handling mistakes during testing | Low | High | Use anonymized or sample data only, restrict uploads, and maintain a test-data checklist | Xiao Xiangyu |
...
| API quota shortages or platform instability | Medium | Medium | Monitor usage, cache results where possible, and prepare fallback demo cases | Lin Qi |
...
### 10.4 Dependencies on Other Projects or Areas Within or Outside the Organization
...
### 10.5 Assessment of the Project's Impact on the Organization
...
| Outstanding Issue | Current Status |
| --- | --- |
...
| --- | --- | --- |
| Xiao Xiangyu | Participates in platform planning, design, implementation, testing, documentation, and presentation | Stronger emphasis on architecture design, AI capability integration, frontend/backend technical implementation, and cross-module integration |
| Hu Baoyi | Participates in platform planning, design, implementation, testing, documentation, and presentation | Stronger emphasis on model-service refinement, logic tuning, and capability polishing |
| Da Sirui | Participates in platform planning, design, implementation, testing, documentation, and presentation | Stronger emphasis on workflow organization, interaction expression, and presentation-layer consistency |
| Lin Qi | Participates in platform planning, design, implementation, testing, documentation, and presentation | Stronger emphasis on interface integration, testing organization, and delivery preparation |

### 11.6 Implementation and Project Closure Plan
...
### 12.2 Names, Signatures, and Dates for Approval

| Role | Name | Signature | Date |
| --- | --- | --- | --- |
| Faculty Advisor / Course Supervisor | Du Bowen |  |  |
| Team Leader / Project Manager | Xiao Xiangyu (2351110) |  |  |
| Security and Compliance Reviewer | Xiao Xiangyu (2351110) |  |  |
| Legal Reviewer | TBD |  |  |
